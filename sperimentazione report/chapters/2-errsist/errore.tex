...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{"../sperimentazione nei propulsori/err_sist_short"}
	\caption{Risultati del processo di ottimizzazione}
	\label{fig:errsistshort}
\end{figure}
In Tab.\ref{tab:risshort} si riportano inoltre tutti i risultati associati alla migliore soluzione. 
\begin{table}[H]
	\centering
	\begin{tabular}{c|c}
		\toprule
