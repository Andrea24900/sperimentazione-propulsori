...
n_classes=10;
class_width_short=25;
classes_short=[(min_short-0.5e-6):class_width_short:(n_classes*class_width_short+min_short-0.5e-6)];
class_width_long=55;
classes_long=[(min_long-0.5e-6):class_width_long:(n_classes*class_width_long+min_long-0.5e-6)];
...
rel_freq_short=N_short;

rel_freq_long=N_long;
